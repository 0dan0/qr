...
Number of days <input type="range" id="tldays" name="tldays" min="0" max="60" value="0" width="200"><label for="tldays"></label> <b id="daystext"></b>

Number of hours <input type="range" id="tlhours" name="tlhours" min="0" max="48" value="10" width="200"><label for="tlhours"></label> <b id="hourstext"></b>
