...
## Example Pre-built Commands for All Labs Cameras
...
## Commands for HERO8, HERO9 and MAX
...
## New Features for Labs 2021 Releases (All Labs Cameras)
...
## New 2021 Commands for HERO8 and HERO9
* Configure your camera for [**Live-streaming**](./rtmp) via QR Code

## New 2021 Commands for HERO9 only
