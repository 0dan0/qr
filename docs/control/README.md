...
* <span style="color:blue">NEW</span> Subset of commands for the [**HERO 5 Session**](./session5) commands
...
* <span style="color:blue">NEW</span> **HERO9 only** Start capture using [**Sound Pressure Level Trigger**](./spltrigger)
...
* <span style="color:blue">NEW</span> **HERO9 only** [**Daily Time-lapse with auto upload**](./dailytl) (GoPro Scribtion required)

### Video Alteration Features
* **HERO8/9 and MAX Only** Add text like Date and Time with [**Video 'Burn-in' Overlays**](./overlays)
* <span style="color:blue">NEW</span> **HERO9 only** Add a logo to small graphics to your video with [**Logo Overlays**](./logo)
...
* <span style="color:blue">NEW</span> **HERO9 only** - Timecode Support via LTC over audio line-in using Media Mod 
* <span style="color:blue">NEW</span> **HERO9 only** -- Enable media encryption for increased security
* <span style="color:blue">NEW</span> Many more [**extensions**](./extensions) via QR Code

<span style="color:blue">NEW</span> - Requires Labs Firmware release in May 2012.
