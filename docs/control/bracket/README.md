...
let cmd = String.raw`*BRKT="!Z1=Ct:ScFi1x0=Bz!N==zB!R-6$BASE='B$C_'$GAMA=2.2x2!S!Nx0!S!Nx-2!S!N=C+1!R14"`;
...
async function updateQRs()
{
	...
	{
		cmd = cmd + String.raw`=C+1=C%89<C10=C+10$BASE='B$C_'`; offset += 30;
