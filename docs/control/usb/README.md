...
Start <input type="range" id="tlsec" name="tlsec" min="0" max="60" value="0"><label for="tlsec"></label>&nbsp;&nbsp;<b id="secstext"></b> seconds after USB power,<br> 
and end after <input type="range" id="tlendsec" name="tlendsec" min="0" max="120" value="10"><label for="tlendsec"></label>&nbsp;&nbsp;<b id="secsendtext"></b> second after USB power is off.
...
function timeLoop()
{
  if(document.getElementById("tlsec") !== null)
  {
	...
	cmd = cmd + "!u" + secs + "NmNLeA!1S!u" + endsecs + "E";
