...
Capture Length: <input type="range" style="width: 200px;" id="tlend" name="tlend" min="1" max="960" value="240"><label for="tlend"></label> <b id="lentext"></b> minutes &nbsp;&nbsp; End Time: <b id="endtext"></b>
