...
- **PRXY=1** <span style="color:steelblue">**NEW**</span> - Store LRV files as Adobe Premiere Pro™ style proxy files. Normally a camera will encode and LRV (Low Res Video) for every MP4 using this standard directory structure:
DCIM/100GOPRO/GX013784.MP4
DCIM/100GOPRO/GL013784.LRV
DCIM/100GOPRO/GX013785.MP4
DCIM/100GOPRO/GL013785.LRV

When Proxies enabled, the same files will be created with name naming that is ready for Premiere Pro's **Attach Proxies** function, greating speeding up a professional workflow.  The new folder structure is:
DCIM/100GOPRO/GX013784.MP4
DCIM/100GOPRO/GX013785.MP4
DCIM/100GOPRO/Proxies/GX013784_Proxy.MP4
DCIM/100GOPRO/Proxies/GX013785_Proxy.MP4

When using a camera with this feature enabled, the lack of LRVs will mean the Quik App will not be able to preview video on the camera.  This will not prevent the full resolution transfer of MP4s, or on camera playback.
