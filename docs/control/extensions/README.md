...
- **SHMX=time** - SHMX is similar Maximum Shutter Angle (EXPT), except it applies to Photos. e.g. SHMX=1000 would set 1/1000th of seconds and the longest shut time. Use case: action photography in lower light. 
