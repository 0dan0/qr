...
Examples:
 * GPS Location - add **GPS: &prime;GPS50%1.6f&prime;, &prime;GPS51%1.6f&prime;**
 * Sensor ISO - add **ISO: &prime;ISOE%d&prime;**
 * Ground Speed - add **speed: &prime;GPS53%1.2f&prime;m/s**
