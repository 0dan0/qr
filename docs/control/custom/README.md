...
**†/††** indicates the control requires HERO10/11 Labs. Many features of this page are also available as a mobile app.<br>
...
<b>Video Resolution:</b>&nbsp;&nbsp;<input type="radio" id="r12" name="res" value="" checked> <label for="r12">not set</label><br>
  ...
  <input type="radio" id="r9" name="res" value="r5T"  > <label for="r9">5k 4:3† </label>&nbsp;&nbsp;
  <input type="radio" id="r10" name="res" value="r4X"  > <label for="r10">4k 8:7†† </label>&nbsp;&nbsp;
  <input type="radio" id="r11" name="res" value="r5X"  > <label for="r11">5k 8:7†† </label><br><br>
</div>
...
<b>Video Resolution:</b>&nbsp;&nbsp;
  ...
  <input type="radio" id="rt5" name="restlv" value="r4T"  > <label for="rt5">4k 4:3† </label>&nbsp;&nbsp;
  <input type="radio" id="rt6" name="restlv" value="r5"   > <label for="rt4">5k†† </label>&nbsp;&nbsp;
  <input type="radio" id="rt7" name="restlv" value="r5T"  > <label for="rt5">5k 4:3†† </label>&nbsp;&nbsp;
...
<b>Lens:</b>
 ...
 <!-- <input type="radio" id="f2" name="fov" value="fM"> <label for="f2">Medium </label>&nbsp;&nbsp; -->
  ...
  <input type="radio" id="f6" name="fov" value="fV"> <label for="f6">Hyperview </label><br>
...
<div id="ptBITRATE">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Bit rate:</b>&nbsp;&nbsp;
  ...
  <input type="radio" id="dp1" name="dp" value="d0"> <label for="br1">8-bit</label>&nbsp;&nbsp;
  <input type="radio" id="dp2" name="dp" value="d1"> <label for="br2">10-bit</label>&nbsp;&nbsp;
  <input type="radio" id="dp3" name="dp" value="" checked> <label for="br3">not set</label>
