...
<div id="ptISO">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ISO Limit:</b>&nbsp;&nbsp;
  <input type="radio" id="iso1" name="iso" value="i4" > <label for="iso3">400 </label>&nbsp;&nbsp;
  <input type="radio" id="iso2" name="iso" value="i8" > <label for="iso4">800 </label>&nbsp;&nbsp;
  <input type="radio" id="iso3" name="iso" value="i16"> <label for="iso5">1600 (def) </label>&nbsp;&nbsp;
